...
function HumanServicesCharities(){
    ...
    const fetchCharities = () => {
        ...
        fetch(SERVER_URL+'api/charities/search/findByCatName?catName=human services', {headers: {'Authorization': token}})
    ...
    return (
        ...
        <React.Fragment>
            <Stack alignItems="center" textAlign='left'>
                <div style={{width:'92%'}}>
                    <h1 className='Category-Headings'> Category: Human Services</h1>
                </div>
            </Stack>
...
export default HumanServicesCharities;